...
<select name="fondo" id="fondo" onchange="cambiarFondo(this)">
  ...
  <section id="contenido">
      ...
      <article  class ="posteo">
        ...
        <div class="col-12">
          <form  method="POST" action=""id="posteo" >
              @csrf  
      ...
      <div class="textarea">
        ...
        <a href="{{route('posts.edit',$post->id)}}">  <button class="btn btn-info"></button></a>
                                                                              
        <a href=""data-target="#modal-delete-{{$post->id}}" data-toggle="modal"><button class="btn btn-danger"></button></a>
      ...
      @endforeach
         ...
         <p class="edit"> <button class="btn btn-info"></button>para modificar</p>
                                                                              
        <p class="borrar" data-toggle="modal"><button class="btn btn-danger"></button>para borrar</p>
